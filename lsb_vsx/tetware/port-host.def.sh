...
#shellcheck disable=2034
{
	...
	name="tetware_host"
	version="2.0"
	desc="A universal, multi-platform test execution management system used to automate, sequence, and report on software tests"
...
p_build() {
	...
	b_install_host "${PREFIX_PORT_WORKDIR}/bin/tcc"
